...
public interface IUbicacionDAO extends JpaRepository<Ubicacion, Integer> {
    ...
    @Query("SELECT u FROM Ubicacion u GROUP BY u.idUbicacion, u.paisUbicacion")
    Set<Ubicacion> findAllPaises();

    @Query("SELECT u FROM Ubicacion u GROUP BY u.idUbicacion, u.paisUbicacion, u.departamentoUbicacion")
    Set<Ubicacion> findAllDepartamentos();

    @Query("SELECT u FROM Ubicacion u GROUP BY u.idUbicacion, u.paisUbicacion, u.departamentoUbicacion, u.provinciaUbicacion")
